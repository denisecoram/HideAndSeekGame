        ...
        public void Run()
        {
            ...
            while (userGuessLevelOne != correctHidingLevelOne)
            {
                ...
                if (userGuessAgainLevelOne == correctHidingLevelOne)
                {
                    ...
                    Console.WriteLine("You're on the right track! Now, choose a room to look in: left side, right side, or the middle?");
                    string userGuessLevelTwoA = Console.ReadLine().ToLower();
                    while (userGuessLevelTwoA != correctHidingLevelTwo)
                    {
                        Console.WriteLine("Nope, I'm not in there! Guess again: left side, right side, or the middle?");
